      ...
      <div className={styles.page}>
        ...
        <div className={styles.body}>
          ...
          <div className={styles.subsection}>
            <List
              list={chatRequestOptions}
              initialv={chatRequests}
              type="Who can send you chat requests"
              displayedColor="grey"
              choose={(item) => {
                setChatRequests(item);
              }}
            />
            <List
              list={privateMessagesOptions}
              initialv={privateMesssages}
            ...
            {showApprovedUsers && (
              <div style={{ paddingLeft: "32px" }}>
                <Add
                  type="Approved Users"
                  description="Approved users can always send you private messages."
